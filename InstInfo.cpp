...
InstInfoTable::setupInstVec()
{
  ...
  instVec_ =
	...
	OperandType::FpReg, OperandMode::Read, rs2Mask },
      ...
      { "fsub_s", InstId::fsub_s, 0x08000053, faddMask,
	InstType::Fp,
	OperandType::FpReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask,
	OperandType::FpReg, OperandMode::Read, rs2Mask },

      { "fmul_s", InstId::fmul_s, 0x10000053, faddMask,
	InstType::Fp,
	OperandType::FpReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask,
	OperandType::FpReg, OperandMode::Read, rs2Mask },

      { "fdiv_s", InstId::fdiv_s, 0x18000053, faddMask,
	InstType::Fp,
	OperandType::FpReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask,
	OperandType::FpReg, OperandMode::Read, rs2Mask },

      { "fsqrt_s", InstId::fsqrt_s, 0x58000053, fsqrtMask,
	InstType::Fp,
	OperandType::FpReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask },

      { "fsgnj_s", InstId::fsgnj_s, 0x20000053, top7Funct3Low7Mask,
	InstType::Fp,
	OperandType::FpReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask,
	OperandType::FpReg, OperandMode::Read, rs2Mask },

      { "fsgnjn_s", InstId::fsgnjn_s, 0x20001053, top7Funct3Low7Mask,
	InstType::Fp,
	OperandType::FpReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask,
	OperandType::FpReg, OperandMode::Read, rs2Mask },

      { "fsgnjx_s", InstId::fsgnjx_s, 0x20002053, top7Funct3Low7Mask,
	InstType::Fp,
	OperandType::FpReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask,
	OperandType::FpReg, OperandMode::Read, rs2Mask },

      { "fmin_s", InstId::fmin_s, 0x28000053, top7Funct3Low7Mask,
	InstType::Fp,
	OperandType::FpReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask,
	OperandType::FpReg, OperandMode::Read, rs2Mask },

      { "fmax_s", InstId::fmax_s, 0x28001053, top7Funct3Low7Mask,
	InstType::Fp,
	OperandType::FpReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask,
	OperandType::FpReg, OperandMode::Read, rs2Mask },

      { "fcvt_w_s", InstId::fcvt_w_s, 0xc0000053, fsqrtMask,
	InstType::Fp,
	OperandType::FpReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask },

      { "fcvt_wu_s", InstId::fcvt_wu_s, 0xc0100053, fsqrtMask,
	InstType::Fp,
	OperandType::FpReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask },

      { "fmv_x_w", InstId::fmv_x_w, 0xe0900053, 0xfff1c07f,
	InstType::Fp,
	OperandType::IntReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask },

      { "feq_s", InstId::feq_s, 0xa0002053, top7Funct3Low7Mask,
	InstType::Fp,
	OperandType::IntReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask,
	OperandType::FpReg, OperandMode::Read, rs2Mask },

      { "flt_s", InstId::flt_s, 0xa0001053, top7Funct3Low7Mask,
	InstType::Fp,
	OperandType::IntReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask,
	OperandType::FpReg, OperandMode::Read, rs2Mask },

      { "fle_s", InstId::fle_s, 0xa0000053, top7Funct3Low7Mask,
	InstType::Fp,
	OperandType::IntReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask,
	OperandType::FpReg, OperandMode::Read, rs2Mask },

      { "fclass_s", InstId::fclass_s, 0xe0001053, 0xfff1c07f,
	InstType::Fp,
	OperandType::IntReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask },

      { "fcvt_s_w", InstId::fcvt_s_w, 0xd0000053, fsqrtMask,
	InstType::Fp,
	OperandType::IntReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask },

      { "fcvt_s_wu", InstId::fcvt_s_wu, 0xd0100053, fsqrtMask,
	InstType::Fp,
	OperandType::FpReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask },

      { "fmv_w_x", InstId::fmv_w_x, 0xf0000053, 0xfff1c07f,
	InstType::Fp,
	OperandType::FpReg, OperandMode::Write, rdMask,
	OperandType::IntReg, OperandMode::Read, rs1Mask },
	...
	OperandType::FpReg, OperandMode::Read, rs2Mask },
      ...
      { "fsub_d", InstId::fsub_d, 0x0a000053, faddMask,
	InstType::Fp,
	OperandType::FpReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask,
	OperandType::FpReg, OperandMode::Read, rs2Mask },

      { "fmul_d", InstId::fmul_d, 0x12000053, faddMask,
	InstType::Fp,
	OperandType::FpReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask,
	OperandType::FpReg, OperandMode::Read, rs2Mask },

      { "fdiv_d", InstId::fdiv_d, 0x1b000053, faddMask,
	InstType::Fp,
	OperandType::FpReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask,
	OperandType::FpReg, OperandMode::Read, rs2Mask },

      { "fsqrt_d", InstId::fsqrt_d, 0x5b000053, fsqrtMask,
	InstType::Fp,
	OperandType::FpReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask },

      { "fsgnj_d", InstId::fsgnj_d, 0x22000053, top7Funct3Low7Mask,
	InstType::Fp,
	OperandType::FpReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask,
	OperandType::FpReg, OperandMode::Read, rs2Mask },

      { "fsgnjn_d", InstId::fsgnjn_d, 0x22001053, top7Funct3Low7Mask,
	InstType::Fp,
	OperandType::FpReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask,
	OperandType::FpReg, OperandMode::Read, rs2Mask },

      { "fsgnjx_d", InstId::fsgnjx_d, 0x22002053, top7Funct3Low7Mask,
	InstType::Fp,
	OperandType::FpReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask,
	OperandType::FpReg, OperandMode::Read, rs2Mask },

      { "fmin_d", InstId::fmin_d, 0x2b000053, top7Funct3Low7Mask,
	InstType::Fp,
	OperandType::FpReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask,
	OperandType::FpReg, OperandMode::Read, rs2Mask },

      { "fmax_d", InstId::fmax_d, 0x2b001053, top7Funct3Low7Mask,
	InstType::Fp,
	OperandType::FpReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask,
	OperandType::FpReg, OperandMode::Read, rs2Mask },

      { "fcvt_s_d", InstId::fcvt_s_d, 0x40100053, fsqrtMask,
	InstType::Fp,
	OperandType::FpReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask },

      { "fcvt_d_s", InstId::fcvt_d_s, 0x42000053, fsqrtMask,
	InstType::Fp,
	OperandType::FpReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask },

      { "feq_d", InstId::feq_d, 0xa2002053, top7Funct3Low7Mask,
	InstType::Fp,
	OperandType::IntReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask,
	OperandType::FpReg, OperandMode::Read, rs2Mask },

      { "flt_d", InstId::flt_d, 0xa2001053, top7Funct3Low7Mask,
	InstType::Fp,
	OperandType::IntReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask,
	OperandType::FpReg, OperandMode::Read, rs2Mask },

      { "fle_d", InstId::fle_d, 0xa2000053, top7Funct3Low7Mask,
	InstType::Fp,
	OperandType::IntReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask,
	OperandType::FpReg, OperandMode::Read, rs2Mask },

      { "fclass_d", InstId::fclass_d, 0xe2001053, 0xfff1c07f,
	InstType::Fp,
	OperandType::IntReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask },

      { "fcvt_w_d", InstId::fcvt_w_d, 0xf2000053, 0xfff1c07f,
	InstType::Fp,
	OperandType::FpReg, OperandMode::Write, rdMask,
	OperandType::IntReg, OperandMode::Read, rs1Mask },

      { "fcvt_wu_d", InstId::fcvt_wu_d, 0xc2100053, fsqrtMask,
	InstType::Fp,
	OperandType::FpReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask },

      { "fcvt_d_w", InstId::fcvt_d_w, 0xd2000053, fsqrtMask,
	InstType::Fp,
	OperandType::IntReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask },

      { "fcvt_d_wu", InstId::fcvt_d_wu, 0xd2100053, fsqrtMask,
	InstType::Fp,
	OperandType::FpReg, OperandMode::Write, rdMask,
	OperandType::FpReg, OperandMode::Read, rs1Mask },
